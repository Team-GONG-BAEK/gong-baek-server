...
class EveryGroupRepositoryQuerydslTest {
    ...
    @Test
    @DisplayName("QueryDSL - 카테고리와 요일로 EveryGroup 조회")
    void findByCategoryAndWeekDay() {
        ...
        GongbaekTimeSlotEntity slotMonday = GongbaekTimeSlotFixture.createWithWeekDay(WeekDay.MON);
        em.persist(slotFriday);
        em.persist(slotFriday2);
        em.persist(slotMonday);

        // STUDY + FRIDAY (조회 대상)
        EveryGroupEntity group1 = EveryGroupEntity.builder()
        ...
        // STUDY + MONDAY
        EveryGroupEntity group2 = EveryGroupEntity.builder()
                .userEntity(userEntity)
                .category(Category.STUDY)
                .status(Status.RECRUITING)
        ...
        // DINING + FRIDAY
        EveryGroupEntity group3 = EveryGroupEntity.builder()
                .userEntity(userEntity)
        ...
        // when
        List<EveryGroupEntity> result1 = everyGroupRepository.findGroupsByCategoryAndDay(Category.STUDY, WeekDay.FRI);
        List<EveryGroupEntity> result2 = everyGroupRepository.findGroupsByCategoryAndDay(Category.STUDY, null);
        List<EveryGroupEntity> result3 = everyGroupRepository.findGroupsByCategoryAndDay(null, WeekDay.FRI);
        List<EveryGroupEntity> result4 = everyGroupRepository.findGroupsByCategoryAndDay(null, null);
        ...
        assertThat(result4.get(1).getGongbaekTimeSlotEntity().getWeekDay()).isEqualTo(WeekDay.MON);
    }
}
